...
<Tabs>
<Tab zoneid="PFfUkNq8UZ" title="Curl">
...
<Tab zoneid="O0DzHWbZPF" title="Python">
...
<Tab zoneid="ZLThrPrrX6" title="Go">
...
<Tab zoneid="ahYl3HxwyB" title="Java">
...
<Tab zoneid="fHepPPUDsJ" title="OpenAI SDK">
...
* [Responses API](https://docs.volcengine.com/docs/82379/1569618)：支持图片作为输入进行分析。支持文件路径上传进行图片理解，使用方式参见[文件路径上传（推荐）](https://docs.volcengine.com/docs/82379/1362931#2c38c01b)。

* [Chat API](https://docs.volcengine.com/docs/82379/1494384)：支持图片作为输入进行分析。
...
* 本地文件上传：
   ...
   * [文件路径上传（推荐）](https://docs.volcengine.com/docs/82379/1362931#2c38c01b)：直接传入本地文件路径，文件大小不能超过 512 MB。

   * [Base64 编码传入](https://docs.volcengine.com/docs/82379/1362931#477e51ce)：适用于图片文件体积较小的场景，单张图片小于 10 MB，请求体不能超过 64 MB。

* [图片 URL 传入](https://docs.volcengine.com/docs/82379/1362931#d86010f4)：适用于图片文件已存在公网可访问 URL 的场景，单张图片小于 10 MB。
...
> * 如果需要实时获取分析内容，或者要规避复杂任务引发的客户端超时失败问题，可采用流式输出的方式，使用方式可参见[示例代码](https://docs.volcengine.com/docs/82379/2123275#9346c907)。

> * 支持直接使用 Files API 上传本地文件，具体请参见[文件输入(File API)](https://docs.volcengine.com/docs/82379/1885708)。



<Tabs>
<Tab zoneid="nwhVW0ZFEd" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="Z1ExBoZOCg" title="Go">
<TabTitle>Go</TabTitle>
...
* <div data-tips="true" data-tips-type="warning"><code>{mime_type}</code>：文件的媒体类型，需要与文件格式mime_type对应。支持的图片格式详细见<a href="https://docs.volcengine.com/docs/82379/1362931#51efc45f">图片格式说明</a>。</div>
...
|[Chat API](https://docs.volcengine.com/docs/82379/1494384) |[Responses API](https://docs.volcengine.com/docs/82379/1569618) |
|---|---|
...
<Tabs>
<Tab zoneid="vPDPTnifoi" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="kt2hQep6qA" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="E2ls5nfFsu" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="vClm7BXcT3" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="fDmkSqE6hO" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="zsFrExCf7b" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="LPzLGAwOkS" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="IJnICUNTUX" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="VT2Zhl0hcY" title="Java">
<TabTitle>Java</TabTitle>
...
* Responses API 示例代码：[快速开始](https://docs.volcengine.com/docs/82379/1362931#18cf565a)
...
<Tabs>
<Tab zoneid="JoOGS8Z0lh" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="fmo09tdFVB" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="gIL4y2VGSq" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="XMhnDwSgKE" title="Java">
<TabTitle>Java</TabTitle>
...
<Tabs>
<Tab zoneid="dXJv5xcTDU" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="TYdXTHMSs2" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="Dd66bYUMQq" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="IW8RMG8SuB" title="Java">
<TabTitle>Java</TabTitle>
...
<Tabs>
<Tab zoneid="GCPzGd41m2" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="T2VoK5qAEM" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="VWfkfhP7lE" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="yEKpTxVP7N" title="Java">
<TabTitle>Java</TabTitle>
...
* 缺省时生效： **image_pixel_limit** 字段的 **min_pixels** / **max_pixels** 字段未设置，则使用 **detail** 默认值配置所对应的值。具体范围参见[通过 detail 字段（图片理解）](https://docs.volcengine.com/docs/82379/1362931#885d96dc)。
...
<Tabs>
<Tab zoneid="DxH2coCv8v" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="jhKNudu7oB" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="ctEaiASgYT" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="IkfQHedufq" title="Java">
<TabTitle>Java</TabTitle>
...
<Tabs>
<Tab zoneid="LgacW37c4J" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="uuAyVi78wr" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="tJLYmYNW7Z" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="DGmng4jErI" title="Java">
<TabTitle>Java</TabTitle>
...
<div data-tips="true" data-tips-type="tip"><code>max_pixels</code> 为图片最大像素，<code>min_pixels</code> 为图片最小像素。</div>
...
<Tabs>
<Tab zoneid="Xv0C9vwF98" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="aWylvBy7I3" title="Python">
<TabTitle>Python</TabTitle>
...
<Tabs>
<Tab zoneid="LbLLSUW2CV" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="Cr5OvNrb1Y" title="Python">
<TabTitle>Python</TabTitle>
...
<Tabs>
<Tab zoneid="WfTDmCKVeZ" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="Wc4sVl3by3" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="oPVYIQ1Kfl" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="YDvNSoI7ck" title="Java">
<TabTitle>Java</TabTitle>
...
<Tabs>
<Tab zoneid="ITJRT4qRaL" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="oUpQAFOrCr" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="PaPS1QTI4I" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="qJN9sWbyeN" title="Java">
<TabTitle>Java</TabTitle>
...
请参见教程 [视觉定位 Grounding](https://docs.volcengine.com/docs/82379/1616136)。

<span id="52afa2e1"></span>
## GUI任务处理

请参见教程 [GUI Agent 能力](https://docs.volcengine.com/docs/82379/1584296)。
...
2. 图片预处理：
   ...
   根据使用的模型、设置的 detail 模式，将图片等比例缩放至相应的范围（具体见[通过 detail 字段（图片理解）](https://docs.volcengine.com/docs/82379/1362931#885d96dc)），可降低模型响应时延及 token 消耗。


<span id="57188ace"></span>
## 图片 token 用量说明

根据图片宽高像素计算得到 token 用量。不同模型的图片 token 用量估算逻辑如下。单图 token 范围参见[通过 detail 字段（图片理解）](https://docs.volcengine.com/docs/82379/1362931#885d96dc)。


<span aceTableMode="list" aceTableWidth="1,1"></span>
|doubao\-seed\-1.8 之前的模型 |doubao\-seed\-1.8 模型、doubao\-seed\-2.0 模型 |
|---|---|
|```Text```<br>```min(image_width * image_height ÷ 784, max_image_tokens)```<br> |```Text```<br>```min(image_width * image_height ÷ 1764, max_image_tokens)```<br> |


doubao\-seed\-2.0 及以后模型，以传入模型的单图 token 最大值为 1280 为例，计算图片消耗的 token 数的逻辑如下：


* 图片尺寸为 `1280 px × 960 px`：理解这张图消耗的 token 为`1280×960÷1764=697`，该值小于 1280，根据公式计算消耗 token 数为 697。

* 图片尺寸为 `2560 px × 1440 px`：理解这张图消耗的 token 为`2560×1440÷1764=2090`，该值大于 1280，根据公式计算消耗 token 数为 1280。
...
> 模型上下文窗口请参见[模型列表](https://docs.volcengine.com/docs/82379/1330310)。
...
|HEIF |.heif |`image/heic`<br><br>> doubao\-1.5\-vision\-pro及以后模型支持 |
...
* <div data-tips="true" data-tips-type="tip">上传文件至对象存储时设置，详情请参见 <a href="https://www.volcengine.com/docs/6349/145523#.6K6-572u5paH5Lu25YWD5pWw5o2u">文档</a>。</div>


* <div data-tips="true" data-tips-type="tip">传入 Base64编码时使用：<a href="https://docs.volcengine.com/docs/82379/1362931#477e51ce">Base64 编码输入</a>。</div>


* <div data-tips="true" data-tips-type="tip">图片格式需小写。</div>


* <div data-tips="true" data-tips-type="tip">TIFF、 SGI、ICNS、JPEG2000 几种格式图片，需保证和元数据对齐，如在对象存储中正确设置文件元数据，否则会解析失败，详细请参见 <a href="https://docs.volcengine.com/docs/82379/1359411#effccb14">使用视觉理解模型时，报错InvalidParameter？</a></div>
...
* [使用视觉理解模型时，报错InvalidParameter？](https://docs.volcengine.com/docs/82379/1359411#effccb14)
