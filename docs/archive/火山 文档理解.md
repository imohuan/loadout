...
* 本地文件上传：
   ...
   * [Files API 上传（推荐）](https://www.volcengine.com/docs/82379/1902647#d6d033c5)：直接传入本地文件路径，文件大小不能超过 512 MB。

   * [Base64 编码传入](https://www.volcengine.com/docs/82379/1902647#8160343d)：适用于文件体积较小的场景，文件小于 50 MB，请求体不能超过 64 MB。

* [文件 URL 传入](https://www.volcengine.com/docs/82379/1902647#69145d66)：适用于文件已存在公网可访问 URL 的场景，文件大小不能超过 50 MB。
...
建议优先使用 Files API 上传本地文件，不仅可以支持最大 512MB 文件的处理，还可以避免请求时重新上传内容，减少预处理导致的时延，同时可在多次请求中重复使用，节省公网下载时延。其中文件预处理的原理，参见[附：文件预处理](https://www.volcengine.com/docs/82379/1902647#dbf9c161)。


> * 该方式上传的文件默认存储 7 天，存储有效期取值范围为1\-30天。

> * 如果需要实时获取分析内容，或者要规避复杂任务引发的客户端超时失败问题，可采用流式输出的方式，具体示例见[流式输出](https://www.volcengine.com/docs/82379/1902647#8e18e610)。
...
<Tabs>
<Tab zoneid="PKkkzoWgjQ" title="Curl">
...
<Tab zoneid="zzIZFvUROH" title="Python">
...
<Tab zoneid="Xp19YV3deL" title="Go">
...
<Tab zoneid="nCjQaTc0ud" title="Java">
...
<Tab zoneid="O9wvmEaVJT" title="OpenAI SDK">
...
<div data-tips="true" data-tips-type="warning">将文档转换为Base64编码字符串，然后遵循<code>data:{mime_type};base64,{base64_data}</code>格式拼接，传入模型。</div>



* <div data-tips="true" data-tips-type="warning"><code>{mime_type}</code>：文件的媒体类型，需要与文件格式mime_type对应（<code>application/pdf</code>）。</div>
...
<Tabs>
<Tab zoneid="Yt56nOxF6V" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="bo5m6WoISq" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="xvOI7MDCRH" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="ie9nFsu1HH" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="DjjiYrokMM" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="kmRsQoTxLm" title="Curl">
<TabTitle>Curl</TabTitle>
...
<Tab zoneid="PsGJh074hn" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="p238XbYH4z" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="ivTCPxJlbW" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="mJbISDPsWL" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
...
<Tabs>
<Tab zoneid="xJPbQBiskI" title="Python">
<TabTitle>Python</TabTitle>
...
<Tab zoneid="uANy1s71r5" title="Go">
<TabTitle>Go</TabTitle>
...
<Tab zoneid="xG4wo7XEN9" title="Java">
<TabTitle>Java</TabTitle>
...
<Tab zoneid="aEpuCOptd3" title="OpenAI SDK">
<TabTitle>OpenAI SDK</TabTitle>
